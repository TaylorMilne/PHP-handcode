...
// # CreatePaymentSample
//
//this file process the checkout of guest
...
{
  $_SESION['err_msg'] = "Get Org bank account failed.";
  return false;
}

//this is guest's credit card
//get credit card info
$sponsor_email=$_SESSION['guest_email'];
...
//price calc
$billing_amount=$_SESSION['billing_amount'];
$total=$_SESSION['total'];
$service_fee=$total-$billing_amount;
$payout=$billing_amount-5;
...
try {
  ...
  $ret=preg_split("/,/", $ret);
  $issue = $ret[2];
  $issue=preg_split("/:/", $issue);
  $issue=str_replace("}]", " ", $issue[1]);*/
