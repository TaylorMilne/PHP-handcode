...
if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_SESSION['is_org']) && !$_SESSION['is_org'])
{
	...
	$contents="<table><thead><tr><td>STATUS</td><td>DATE</td><td>EVENT NAME</td><td>ORGANISATION</td><td>AMOUNT PAID</td><td>TYPE</td><td>ANON</td><td>PKG</td></tr></thead><tbody>";
	...
	// subject
	$subject = 'Please see your orders.';
	...
	<html>
	<head>
	  <title>Sponsored Orders.</title>
	</head>
	<body>
	<p>Sponsored Package content as follows:</p>
	'.$contents.'</body></html>';
	...
	if(mail($to, $subject, $message, $headers))
		echo "Email about sponsored orders has been sent you. Please check email";
	else
		echo "Email sent failed.";
	die();
}else
{
	echo "You can't send email.";
	die();
}
